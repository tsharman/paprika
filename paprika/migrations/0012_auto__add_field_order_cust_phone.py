...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Order.cust_phone'
        db.add_column('paprika_order', 'cust_phone',
                      self.gf('django.contrib.localflavor.us.models.PhoneNumberField')(default='0000000000', max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Order.cust_phone'
        db.delete_column('paprika_order', 'cust_phone')
