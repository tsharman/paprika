...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Order.current_stage'
        db.alter_column('paprika_order', 'current_stage_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['paprika.Stage'], null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Order.current_stage'
        db.alter_column('paprika_order', 'current_stage_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['paprika.Stage']))
