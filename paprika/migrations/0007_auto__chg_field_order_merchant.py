...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Order.merchant'
        db.alter_column('paprika_order', 'merchant_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['paprika.BusinessProfile']))

    def backwards(self, orm):

        # Changing field 'Order.merchant'
        db.alter_column('paprika_order', 'merchant_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
