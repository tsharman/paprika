...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Order.time_entered'
        db.alter_column('paprika_order', 'time_entered', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'Order.time_entered'
        db.alter_column('paprika_order', 'time_entered', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
