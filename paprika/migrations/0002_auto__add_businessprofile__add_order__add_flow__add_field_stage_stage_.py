...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Stage.stage_num'
        db.add_column('paprika_stage', 'stage_num',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding field 'Stage.flow'
        db.add_column('paprika_stage', 'flow',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='stages', to=orm['paprika.Flow']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Stage.stage_num'
        db.delete_column('paprika_stage', 'stage_num')

        # Deleting field 'Stage.flow'
        db.delete_column('paprika_stage', 'flow_id')
