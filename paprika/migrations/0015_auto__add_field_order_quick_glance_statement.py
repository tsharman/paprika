...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Order.quick_glance_statement'
        db.add_column('paprika_order', 'quick_glance_statement',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Order.quick_glance_statement'
        db.delete_column('paprika_order', 'quick_glance_statement')
    ...
    models = {
        ...
        'paprika.order': {
            ...
            'quick_glance_statement': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '100'}),
