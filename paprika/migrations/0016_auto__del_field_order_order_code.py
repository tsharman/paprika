...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Order.order_code'
        db.delete_column('paprika_order', 'order_code')


    def backwards(self, orm):
        # Adding field 'Order.order_code'
        db.add_column('paprika_order', 'order_code',
    ...
    models = {
        ...
        'paprika.order': {
            ...
            'quick_glance_statement': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '100', 'blank': 'True'}),
